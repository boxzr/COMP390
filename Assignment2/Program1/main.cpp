 ...
 * 
 * creates a house model using display lists
 * with three parts: ground, body, and pyramid top
 */
...
// create a display list for the house model
...
void display() {
    ...
    // set up view
    glLoadIdentity();
    gluLookAt(3.0f, 2.0f, 5.0f,   // eye position
              0.5f, 0.5f, 0.5f,   // look at position
